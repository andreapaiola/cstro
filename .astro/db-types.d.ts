...
declare module 'astro:db' {
	...
	export const HtmlTemplate: import("@astrojs/db/runtime").Table<
		"HtmlTemplate",
		{"id":{"type":"number","schema":{"unique":false,"deprecated":false,"name":"id","collection":"HtmlTemplate","primaryKey":true}},"name":{"type":"text","schema":{"unique":false,"deprecated":false,"name":"name","collection":"HtmlTemplate","primaryKey":false,"optional":false}},"content":{"type":"text","schema":{"unique":false,"deprecated":false,"name":"content","collection":"HtmlTemplate","primaryKey":false,"optional":false}}}
	>;
}
